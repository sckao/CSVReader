...
public:
   ...
   void ReadFreeCSV( string fileName, vector<vec>& dataV, int nSkipLine = 0, int nStopLine = -1 ) ;
   void ReadStringCSV( string fileName, vector<svec>& dataV, int nSkipLine = 0, int nStopLine = -1 ) ;
